    ...
    $("#send_message").on("click", function (event) {
        ...
        if (contact_name == "" || contact_email == "" || contact_phone == "" || contact_message == "" || textInput == "" || contact_subject == selectedNull) {
            ...
            $.ajax({
                ...
                data: { contact_name: contact_name, contact_email: contact_email, contact_phone: contact_phone, contact_subject: contact_subject, contact_message: contact_message },
                type: "POST",
